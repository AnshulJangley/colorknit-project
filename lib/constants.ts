...
export const SERVICES = [
  ...
  },
  {
    ...
    icon: 'Flower2',
    category: 'Decor',
    image: '/images/services/srv-decor.png',
  },
  {
    id: 3,
    title: 'Catering Coordination',
    description: 'Curated menus from the finest caterers. From traditional thalis to global cuisines — every palate satisfied.',
    icon: 'UtensilsCrossed',
    category: 'Catering',
    image: '/images/services/srv-catering.png',
  },
  {
    id: 4,
    ...
    image: '/images/services/srv-photo.png',
  },
  {
    id: 5,
  ...
  {
    id: 6,
    title: 'RSVP & Guest Hospitality',
    description: 'Effortless RSVP management with streamlined guest coordination and support. We ensure a smooth experience with personalized assistance, from confirmations to on-ground hospitality.',
    icon: 'ClipboardList',
    category: 'Hospitality',
    image: '/images/services/srv-rsvp.png',
  },
  {
    id: 7,
    title: 'Wedding Stationery',
    description: 'Beautifully designed wedding stationery that reflects your style and theme. From invitations and save-the-dates to welcome cards and itineraries, every detail is thoughtfully crafted to create a lasting impression.',
    icon: 'Mail',
    category: 'Stationery',
    image: '/images/services/srv-stationery.png',
  },
  {
    id: 8,
    title: 'Artist Management',
    description: 'Curated artist selection and seamless coordination to elevate your celebrations. From live performers to DJs and entertainers, we manage bookings, schedules, and on-ground execution for a memorable experience.',
    icon: 'Music',
    category: 'Entertainment',
    image: '/images/services/srv-artist.jpg',
  },
]
...
export const GALLERY_IMAGES = [
  { id: 1,  src: '/images/gallery/Picture1.png',  category: 'Ceremony' },
  { id: 2,  src: '/images/gallery/Picture2.png',  category: 'Reception' },
  { id: 3,  src: '/images/gallery/Picture3.png',  category: 'Decor' },
  { id: 4,  src: '/images/gallery/Picture4.png',  category: 'Portraits' },
  { id: 5,  src: '/images/gallery/Picture5.png',  category: 'Destination' },
  { id: 6,  src: '/images/gallery/Picture6.png',  category: 'Ceremony' },
  { id: 7,  src: '/images/gallery/Picture7.png',  category: 'Reception' },
  { id: 8,  src: '/images/gallery/Picture8.png',  category: 'Decor' },
  { id: 9,  src: '/images/gallery/Picture9.png',  category: 'Portraits' },
  { id: 10, src: '/images/gallery/Picture11.png', category: 'Destination' },
  { id: 11, src: '/images/gallery/Picture12.png', category: 'Ceremony' },
  { id: 12, src: '/images/gallery/Picture13.png', category: 'Reception' },
  { id: 13, src: '/images/gallery/Picture14.png', category: 'Decor' },
  { id: 14, src: '/images/gallery/Picture15.png', category: 'Portraits' },
  { id: 15, src: '/images/gallery/Picture16.png', category: 'Destination' },
  { id: 16, src: '/images/gallery/Picture17.jpg', category: 'Ceremony' },
  { id: 17, src: '/images/gallery/Picture19.jpg', category: 'Reception' },
  { id: 18, src: '/images/gallery/Picture20.png', category: 'Decor' },
  { id: 19, src: '/images/gallery/Picture21.png', category: 'Portraits' },
  { id: 20, src: '/images/gallery/Picture22.png', category: 'Destination' },
  { id: 21, src: '/images/gallery/Picture23.png', category: 'Ceremony' },
  { id: 22, src: '/images/gallery/Picture24.png', category: 'Reception' },
  { id: 23, src: '/images/gallery/Picture25.png', category: 'Decor' },
  { id: 24, src: '/images/gallery/Picture26.png', category: 'Portraits' },
  { id: 25, src: '/images/gallery/Picture27.png', category: 'Destination' },
  { id: 26, src: '/images/gallery/Picture28.png', category: 'Ceremony' },
]
